...
const TargetAudienceData = [
    {
        ...
        tags: ['Cinematic Property Tours', 'Investor Pitches', 'Geo-Map Explainers'],
    },
    {
        title: 'E-commerce',
    ...
    return (
        ...
        >
            <div className="container mx-auto px-4">
                ...
                With the right audience in mind, having a unique approach to cater your audience is essential. We provide media assets suitable and applicable for all industries, so that you may present yourself before your audience with perfection. 
                </p>
                        ...
                        {TargetAudienceData.map((service, idx) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    onHoverStart={() => !isTouchDevice() && setActiveCardIndex(idx)}
                                    onHoverEnd={() => !isTouchDevice() && setActiveCardIndex(null)}
                                    onClick={() => isTouchDevice() && handleFlip(idx)}
                                >
                                    <motion.div
                                        ...
                                        >
                                            ...
                                            <div
                                                ...
                                                style={{
                                                    ...
                                                    background: 'linear-gradient(to bottom, rgba(0,0,0,1) 0%, rgba(0,0,0,0.6) 50%, rgba(0,0,0,0.2) 75%, transparent 100%)',
                                                }}
                                            >
                                                <h3
