...
We're also currently working to expand our field of expertise by collaborating with different industries, so hopefully you'll see many more names added to this list!`
    ...
    },
    {
        ...
        answer: `Click our “Contact” button for a call or email us at inkwellmedia.agency@gmail.com. We&apos;ll schedule a free consultation to discuss your vision and provide a customized proposal. We're happy to answer any queries you have regarding our work. Looking forward to working with you! :)`
    }
];
...
Now to the questions you may have….
      ...
      Where there is work, obviously there will be a few queries regarding what we did & how it is done. From the overall situation, we accounted for a few and debriefed them accordingly.
        </p>
                </motion.div>
                ...
                {faqs.map((faq, idx) => (
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <Typography sx={{ fontWeight: '600', fontFamily: 'Armata, sans-serif' }}>{faq.question}</Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography className="lexend-font" sx={{ color: 'white', opacity: 0.9 }}>
                                    {faq.answer}
                                </Typography>
                            </AccordionDetails>
                        </Accordion>
