...
const Header: React.FC = () => {
  ...
  const drawer = (
    <Box className="w-full h-full p-0 flex flex-col" sx={{
      ...
      <Box className="mb-6">
        <Link href="/">
          <Image src="https://ik.imagekit.io/Shubham2285/logo.png?updatedAt=1751558258227" alt="Logo" width={100} height={30} />
        </Link>
      </Box>
      <Divider />
            ...
            <Box sx={{ display: "flex", alignItems: "center" }}>
              ...
              <div className="flex items-center justify-center h-full">
                <Link href="/" className="flex items-center justify-center">
                  <IconButton edge="start" disableRipple aria-label="Inkwell Media" className="p-0">
                    <Image src="https://ik.imagekit.io/Shubham2285/logo.png?updatedAt=1751558258227" alt="Inkwell Media Logo" width={120} height={50} priority />
                  </IconButton>
                </Link>
              </div>
            </Box>
