...
const types = [
  ...
  },
  {
    ...
    col: 'lg:col-span-2',
    row: 'lg:row-span-3',
    description: "Engage and entertain, this motto works the best when it comes to quickly capturing the audience's attention and creating attachment.",
...
const CombinedServicesWorkflow: React.FC = () => (
  <section className="py-24" style={{ background: 'linear-gradient(214deg, rgba(0, 2, 5, 1) 0%, rgba(0, 0, 0, 1) 12%, rgba(2, 4, 26, 1) 21%, rgba(2, 2, 61, 1) 36%, rgba(5, 7, 77, 1) 45%, rgba(5, 5, 102, 1) 54%, rgba(13, 13, 128, 1) 69%, rgba(59, 139, 163, 1) 88%, rgba(0, 212, 255, 1) 100%)' }}>
    <div className="container mx-auto px-4 space-y-20">
      ...
      >
        ...
        <motion.p variants={fadeInUp} className="mt-4 text-white/75 max-w-2xl mx-auto">
          From diverse video formats to a transparent three-step production process, here how Inkwell Media brings your vision to life.
        </motion.p>
      </motion.div>
