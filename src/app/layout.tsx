...
fbq('track', 'PageView');` }} />
      ...
      {/* Meta Pixel NoScript */}
      <noscript>
        <img height="1" width="1" style={{display:'none'}} src="https://www.facebook.com/tr?id=1034844105517983&ev=PageView&noscript=1" />
      </noscript>
      <html lang="en" suppressHydrationWarning={true} data-lt-installed="true">
        <head>
          ...
          <link href="https://fonts.googleapis.com/css2?family=Kumar+One+Outline&family=Bebas+Neue&family=Oswald:wght@400;700&family=Oxanium:wght@400;700&family=Electrolize:wght@400;700&family=Nunito:wght@300;400;600;700;900&display=swap" rel="stylesheet" />
        ...
        <body
          style={{
            background: "linear-gradient(316deg, rgba(194, 0, 0, 1) 0%, rgba(143, 0, 0, 1) 10%, rgba(116, 0, 0, 1) 20%, rgba(68, 0, 0, 1) 30%, rgba(5, 0, 0, 1) 64%)", // Light red gradient
            minHeight: "100vh",
            color: "#fff",
        ...
        >
          ...
          <noscript>
            <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-59JZ9WRG" height="0" width="0" style={{display:'none',visibility:'hidden'}}></iframe>
          </noscript>
          <ContextProviders>
            {children}
          </ContextProviders>
